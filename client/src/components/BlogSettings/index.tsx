    ...
    return (
        <div className=" w-52 bg-slate-300/90 absolute top-32 left-10 shadow-md rounded-lg backdrop-blur-md ">
            ...
            <ul>
                ...
                <li className="text-center px-4 py-2 transition duration-300 hover:bg-slate-600 cursor-pointer hover:text-white" onClick={() => setDeleteState(!deleteState)}>Deletar um Post</li>
